...
const opGetInsightIncidentGraph = "GetInsightIncidentGraph"

// GetInsightIncidentGraphRequest generates a "aws/request.Request" representing the
// client's request for the GetInsightIncidentGraph operation. The "output" return
// value will be populated with the request's response once the request completes
// successfully.
//
// Use "Send" method on the returned Request to send the API call to the service.
// the "output" return value is not valid until after Send returns without error.
//
// See GetInsightIncidentGraph for more information on using the GetInsightIncidentGraph
// API call, and error handling.
//
// This method is useful when you want to inject custom logic or configuration
// into the SDK's request lifecycle. Such as custom headers, or retry logic.
//
//
//    // Example sending a request using the GetInsightIncidentGraphRequest method.
//    req, resp := client.GetInsightIncidentGraphRequest(params)
//
//    err := req.Send()
//    if err == nil { // resp is now filled
//        fmt.Println(resp)
//    }
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetInsightIncidentGraph
func (c *XRay) GetInsightIncidentGraphRequest(input *GetInsightIncidentGraphInput) (req *request.Request, output *GetInsightIncidentGraphOutput) {
	op := &request.Operation{
		Name:       opGetInsightIncidentGraph,
		HTTPMethod: "POST",
		HTTPPath:   "/InsightIncidentGraph",
	}

	if input == nil {
		input = &GetInsightIncidentGraphInput{}
	}

	output = &GetInsightIncidentGraphOutput{}
	req = c.newRequest(op, input, output)
	return
}

// GetInsightIncidentGraph API operation for AWS X-Ray.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
//
// See the AWS API reference guide for AWS X-Ray's
// API operation GetInsightIncidentGraph for usage and error information.
//
// Returned Error Types:
//   * InvalidRequestException
//   The request is missing required parameters or has invalid parameters.
...
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetInsightIncidentGraph
func (c *XRay) GetInsightIncidentGraph(input *GetInsightIncidentGraphInput) (*GetInsightIncidentGraphOutput, error) {
	req, out := c.GetInsightIncidentGraphRequest(input)
	return out, req.Send()
}

// GetInsightIncidentGraphWithContext is the same as GetInsightIncidentGraph with the addition of
// the ability to pass a context and additional request options.
//
// See GetInsightIncidentGraph for details on how to use this API operation.
//
// The context must be non-nil and will be used for request cancellation. If
// the context is nil a panic will occur. In the future the SDK may create
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *XRay) GetInsightIncidentGraphWithContext(ctx aws.Context, input *GetInsightIncidentGraphInput, opts ...request.Option) (*GetInsightIncidentGraphOutput, error) {
	req, out := c.GetInsightIncidentGraphRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
const opGetLegacySamplingRules = "GetLegacySamplingRules"

// GetLegacySamplingRulesRequest generates a "aws/request.Request" representing the
// client's request for the GetLegacySamplingRules operation. The "output" return
// value will be populated with the request's response once the request completes
// successfully.
//
// Use "Send" method on the returned Request to send the API call to the service.
// the "output" return value is not valid until after Send returns without error.
//
// See GetLegacySamplingRules for more information on using the GetLegacySamplingRules
// API call, and error handling.
//
// This method is useful when you want to inject custom logic or configuration
// into the SDK's request lifecycle. Such as custom headers, or retry logic.
//
//
//    // Example sending a request using the GetLegacySamplingRulesRequest method.
//    req, resp := client.GetLegacySamplingRulesRequest(params)
//
//    err := req.Send()
//    if err == nil { // resp is now filled
//        fmt.Println(resp)
//    }
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetLegacySamplingRules
func (c *XRay) GetLegacySamplingRulesRequest(input *GetLegacySamplingRulesInput) (req *request.Request, output *GetLegacySamplingRulesOutput) {
	op := &request.Operation{
		Name:       opGetLegacySamplingRules,
		HTTPMethod: "POST",
		HTTPPath:   "/LegacySamplingRules",
	}

	if input == nil {
		input = &GetLegacySamplingRulesInput{}
	}

	output = &GetLegacySamplingRulesOutput{}
	req = c.newRequest(op, input, output)
	return
}

// GetLegacySamplingRules API operation for AWS X-Ray.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
//
// See the AWS API reference guide for AWS X-Ray's
// API operation GetLegacySamplingRules for usage and error information.
//
// Returned Error Types:
//   * InvalidRequestException
//   The request is missing required parameters or has invalid parameters.
...
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetLegacySamplingRules
func (c *XRay) GetLegacySamplingRules(input *GetLegacySamplingRulesInput) (*GetLegacySamplingRulesOutput, error) {
	req, out := c.GetLegacySamplingRulesRequest(input)
	return out, req.Send()
}

// GetLegacySamplingRulesWithContext is the same as GetLegacySamplingRules with the addition of
// the ability to pass a context and additional request options.
//
// See GetLegacySamplingRules for details on how to use this API operation.
//
// The context must be non-nil and will be used for request cancellation. If
// the context is nil a panic will occur. In the future the SDK may create
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *XRay) GetLegacySamplingRulesWithContext(ctx aws.Context, input *GetLegacySamplingRulesInput, opts ...request.Option) (*GetLegacySamplingRulesOutput, error) {
	req, out := c.GetLegacySamplingRulesRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
const opPutExtensibleTelemetry = "PutExtensibleTelemetry"

// PutExtensibleTelemetryRequest generates a "aws/request.Request" representing the
// client's request for the PutExtensibleTelemetry operation. The "output" return
// value will be populated with the request's response once the request completes
// successfully.
//
// Use "Send" method on the returned Request to send the API call to the service.
// the "output" return value is not valid until after Send returns without error.
//
// See PutExtensibleTelemetry for more information on using the PutExtensibleTelemetry
// API call, and error handling.
//
// This method is useful when you want to inject custom logic or configuration
// into the SDK's request lifecycle. Such as custom headers, or retry logic.
//
//
//    // Example sending a request using the PutExtensibleTelemetryRequest method.
//    req, resp := client.PutExtensibleTelemetryRequest(params)
//
//    err := req.Send()
//    if err == nil { // resp is now filled
//        fmt.Println(resp)
//    }
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/PutExtensibleTelemetry
func (c *XRay) PutExtensibleTelemetryRequest(input *PutExtensibleTelemetryInput) (req *request.Request, output *PutExtensibleTelemetryOutput) {
	op := &request.Operation{
		Name:       opPutExtensibleTelemetry,
		HTTPMethod: "POST",
		HTTPPath:   "/ExtensibleTelemetry",
	}

	if input == nil {
		input = &PutExtensibleTelemetryInput{}
	}

	output = &PutExtensibleTelemetryOutput{}
	req = c.newRequest(op, input, output)
	req.Handlers.Unmarshal.Swap(restjson.UnmarshalHandler.Name, protocol.UnmarshalDiscardBodyHandler)
	return
}

// PutExtensibleTelemetry API operation for AWS X-Ray.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
//
// See the AWS API reference guide for AWS X-Ray's
// API operation PutExtensibleTelemetry for usage and error information.
//
// Returned Error Types:
//   * InvalidRequestException
//   The request is missing required parameters or has invalid parameters.
...
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/PutExtensibleTelemetry
func (c *XRay) PutExtensibleTelemetry(input *PutExtensibleTelemetryInput) (*PutExtensibleTelemetryOutput, error) {
	req, out := c.PutExtensibleTelemetryRequest(input)
	return out, req.Send()
}

// PutExtensibleTelemetryWithContext is the same as PutExtensibleTelemetry with the addition of
// the ability to pass a context and additional request options.
//
// See PutExtensibleTelemetry for details on how to use this API operation.
//
// The context must be non-nil and will be used for request cancellation. If
// the context is nil a panic will occur. In the future the SDK may create
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *XRay) PutExtensibleTelemetryWithContext(ctx aws.Context, input *PutExtensibleTelemetryInput, opts ...request.Option) (*PutExtensibleTelemetryOutput, error) {
	req, out := c.PutExtensibleTelemetryRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
//    }
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/VerifyResourcesExistForTagris
func (c *XRay) VerifyResourcesExistForTagrisRequest(input *VerifyResourcesExistForTagrisInput) (req *request.Request, output *VerifyResourcesExistForTagrisOutput) {
	op := &request.Operation{
		Name:       opVerifyResourcesExistForTagris,
		HTTPMethod: "POST",
		HTTPPath:   "/VerifyResourcesExistForTagris",
	}
...
// VerifyResourcesExistForTagris API operation for AWS X-Ray.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/VerifyResourcesExistForTagris
func (c *XRay) VerifyResourcesExistForTagris(input *VerifyResourcesExistForTagrisInput) (*VerifyResourcesExistForTagrisOutput, error) {
...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *XRay) VerifyResourcesExistForTagrisWithContext(ctx aws.Context, input *VerifyResourcesExistForTagrisInput, opts ...request.Option) (*VerifyResourcesExistForTagrisOutput, error) {
	req, out := c.VerifyResourcesExistForTagrisRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
...
func (s *Contributor) SetId(v string) *Contributor {
	s.Id = &v
	return s
}
...
type ContributorCategory struct {
	...
	Contributors []*Contributor `type:"list"`
}

// String returns the string representation
func (s ContributorCategory) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s ContributorCategory) GoString() string {
	return s.String()
}

// SetCategoryName sets the CategoryName field's value.
func (s *ContributorCategory) SetCategoryName(v string) *ContributorCategory {
	s.CategoryName = &v
	return s
}

// SetContributors sets the Contributors field's value.
func (s *ContributorCategory) SetContributors(v []*Contributor) *ContributorCategory {
	s.Contributors = v
	return s
}
...
type ContributorStatistics struct {
	...
	UniqueCount *int64 `type:"long"`
}

// String returns the string representation
func (s ContributorStatistics) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s ContributorStatistics) GoString() string {
	return s.String()
}

// SetCategoryName sets the CategoryName field's value.
func (s *ContributorStatistics) SetCategoryName(v string) *ContributorStatistics {
	s.CategoryName = &v
	return s
}

// SetUniqueCount sets the UniqueCount field's value.
func (s *ContributorStatistics) SetUniqueCount(v int64) *ContributorStatistics {
	s.UniqueCount = &v
	return s
}
...
type DurationRootCause struct {
	_ struct{} `type:"structure"`

	ClientImpacting *bool `type:"boolean"`

	Services []*DurationRootCauseService `type:"list"`
}

// String returns the string representation
func (s DurationRootCause) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s DurationRootCause) GoString() string {
	return s.String()
}

// SetClientImpacting sets the ClientImpacting field's value.
func (s *DurationRootCause) SetClientImpacting(v bool) *DurationRootCause {
	s.ClientImpacting = &v
	return s
}

// SetServices sets the Services field's value.
func (s *DurationRootCause) SetServices(v []*DurationRootCauseService) *DurationRootCause {
	s.Services = v
	return s
}

type DurationRootCauseEntity struct {
	_ struct{} `type:"structure"`
...
// String returns the string representation
func (s DurationRootCauseEntity) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s DurationRootCauseEntity) GoString() string {
	return s.String()
}

// SetCoverage sets the Coverage field's value.
func (s *DurationRootCauseEntity) SetCoverage(v float64) *DurationRootCauseEntity {
	s.Coverage = &v
	return s
}

// SetName sets the Name field's value.
func (s *DurationRootCauseEntity) SetName(v string) *DurationRootCauseEntity {
	s.Name = &v
	return s
}

// SetRemote sets the Remote field's value.
func (s *DurationRootCauseEntity) SetRemote(v bool) *DurationRootCauseEntity {
	s.Remote = &v
	return s
}

type DurationRootCauseService struct {
	_ struct{} `type:"structure"`

	AccountId *string `type:"string"`

	EntityPath []*DurationRootCauseEntity `type:"list"`
...
// String returns the string representation
func (s DurationRootCauseService) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s DurationRootCauseService) GoString() string {
	return s.String()
}

// SetAccountId sets the AccountId field's value.
func (s *DurationRootCauseService) SetAccountId(v string) *DurationRootCauseService {
	s.AccountId = &v
	return s
}

// SetEntityPath sets the EntityPath field's value.
func (s *DurationRootCauseService) SetEntityPath(v []*DurationRootCauseEntity) *DurationRootCauseService {
	s.EntityPath = v
	return s
}

// SetInferred sets the Inferred field's value.
func (s *DurationRootCauseService) SetInferred(v bool) *DurationRootCauseService {
	s.Inferred = &v
	return s
}

// SetName sets the Name field's value.
func (s *DurationRootCauseService) SetName(v string) *DurationRootCauseService {
	s.Name = &v
	return s
}

// SetNames sets the Names field's value.
func (s *DurationRootCauseService) SetNames(v []*string) *DurationRootCauseService {
	s.Names = v
	return s
}

// SetType sets the Type field's value.
func (s *DurationRootCauseService) SetType(v string) *DurationRootCauseService {
	s.Type = &v
	return s
}
...
type ExtensibleTelemetry struct {
	_ struct{} `type:"structure"`

	Counters map[string]*int64 `type:"map"`
...
// String returns the string representation
func (s ExtensibleTelemetry) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s ExtensibleTelemetry) GoString() string {
	return s.String()
}

// Validate inspects the fields of the type to determine if they are valid.
func (s *ExtensibleTelemetry) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "ExtensibleTelemetry"}
	if s.Timestamp == nil {
...
func (s *ExtensibleTelemetry) SetCounters(v map[string]*int64) *ExtensibleTelemetry {
	s.Counters = v
	return s
}

// SetTimestamp sets the Timestamp field's value.
func (s *ExtensibleTelemetry) SetTimestamp(v time.Time) *ExtensibleTelemetry {
	s.Timestamp = &v
	return s
}
...
type ForecastStatistics struct {
	...
	ErrorCountHigh *int64 `type:"long"`

	ErrorCountLow *int64 `type:"long"`
...
// SetErrorCountHigh sets the ErrorCountHigh field's value.
func (s *ForecastStatistics) SetErrorCountHigh(v int64) *ForecastStatistics {
	s.ErrorCountHigh = &v
	return s
}

// SetErrorCountLow sets the ErrorCountLow field's value.
func (s *ForecastStatistics) SetErrorCountLow(v int64) *ForecastStatistics {
	s.ErrorCountLow = &v
	return s
}
...
// SetInsightsConfiguration sets the InsightsConfiguration field's value.
func (s *GetGroupsInput) SetInsightsConfiguration(v *InsightsConfiguration) *GetGroupsInput {
	s.InsightsConfiguration = v
	return s
}
...
type GetInsightIncidentGraphInput struct {
	_ struct{} `type:"structure"`
...
// String returns the string representation
func (s GetInsightIncidentGraphInput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s GetInsightIncidentGraphInput) GoString() string {
	return s.String()
}

// Validate inspects the fields of the type to determine if they are valid.
func (s *GetInsightIncidentGraphInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "GetInsightIncidentGraphInput"}
	if s.EndTime == nil {
...
// SetEndTime sets the EndTime field's value.
func (s *GetInsightIncidentGraphInput) SetEndTime(v time.Time) *GetInsightIncidentGraphInput {
	s.EndTime = &v
	return s
}

// SetInsightId sets the InsightId field's value.
func (s *GetInsightIncidentGraphInput) SetInsightId(v string) *GetInsightIncidentGraphInput {
	s.InsightId = &v
	return s
}

// SetNextToken sets the NextToken field's value.
func (s *GetInsightIncidentGraphInput) SetNextToken(v string) *GetInsightIncidentGraphInput {
	s.NextToken = &v
	return s
}

// SetStartTime sets the StartTime field's value.
func (s *GetInsightIncidentGraphInput) SetStartTime(v time.Time) *GetInsightIncidentGraphInput {
	s.StartTime = &v
	return s
}

type GetInsightIncidentGraphOutput struct {
	_ struct{} `type:"structure"`
	...
	Services []*InsightIncidentGraphService `type:"list"`

	StartTime *time.Time `type:"timestamp"`
}

// String returns the string representation
func (s GetInsightIncidentGraphOutput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s GetInsightIncidentGraphOutput) GoString() string {
	return s.String()
}

// SetEndTime sets the EndTime field's value.
func (s *GetInsightIncidentGraphOutput) SetEndTime(v time.Time) *GetInsightIncidentGraphOutput {
	s.EndTime = &v
	return s
}

// SetInsightId sets the InsightId field's value.
func (s *GetInsightIncidentGraphOutput) SetInsightId(v string) *GetInsightIncidentGraphOutput {
	s.InsightId = &v
	return s
}

// SetNextToken sets the NextToken field's value.
func (s *GetInsightIncidentGraphOutput) SetNextToken(v string) *GetInsightIncidentGraphOutput {
	s.NextToken = &v
	return s
}

// SetServiceGraphEndTime sets the ServiceGraphEndTime field's value.
func (s *GetInsightIncidentGraphOutput) SetServiceGraphEndTime(v time.Time) *GetInsightIncidentGraphOutput {
	s.ServiceGraphEndTime = &v
	return s
}

// SetServiceGraphStartTime sets the ServiceGraphStartTime field's value.
func (s *GetInsightIncidentGraphOutput) SetServiceGraphStartTime(v time.Time) *GetInsightIncidentGraphOutput {
	s.ServiceGraphStartTime = &v
	return s
}

// SetServices sets the Services field's value.
func (s *GetInsightIncidentGraphOutput) SetServices(v []*InsightIncidentGraphService) *GetInsightIncidentGraphOutput {
	s.Services = v
	return s
}

// SetStartTime sets the StartTime field's value.
func (s *GetInsightIncidentGraphOutput) SetStartTime(v time.Time) *GetInsightIncidentGraphOutput {
	s.StartTime = &v
	return s
}
...
type GetLegacySamplingRulesInput struct {
	_ struct{} `type:"structure"`
...
// String returns the string representation
func (s GetLegacySamplingRulesInput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s GetLegacySamplingRulesInput) GoString() string {
	return s.String()
}

// SetNextToken sets the NextToken field's value.
func (s *GetLegacySamplingRulesInput) SetNextToken(v string) *GetLegacySamplingRulesInput {
	s.NextToken = &v
	return s
}

type GetLegacySamplingRulesOutput struct {
	_ struct{} `type:"structure"`

	LegacySamplingRules []*LegacySamplingRule `type:"list"`

	NextToken *string `type:"string"`
}

// String returns the string representation
func (s GetLegacySamplingRulesOutput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s GetLegacySamplingRulesOutput) GoString() string {
	return s.String()
}

// SetLegacySamplingRules sets the LegacySamplingRules field's value.
func (s *GetLegacySamplingRulesOutput) SetLegacySamplingRules(v []*LegacySamplingRule) *GetLegacySamplingRulesOutput {
	s.LegacySamplingRules = v
	return s
}

// SetNextToken sets the NextToken field's value.
func (s *GetLegacySamplingRulesOutput) SetNextToken(v string) *GetLegacySamplingRulesOutput {
	s.NextToken = &v
	return s
}
...
type GetServiceGraphInput struct {
	...
	ContributorCategories []*string `type:"list"`
...
// SetContributorCategories sets the ContributorCategories field's value.
func (s *GetServiceGraphInput) SetContributorCategories(v []*string) *GetServiceGraphInput {
	s.ContributorCategories = v
	return s
}
...
type GroupSummary struct {
	...
	InsightsConfigurationSummary *InsightsConfigurationSummary `type:"structure"`
}
...
// SetInsightsConfigurationSummary sets the InsightsConfigurationSummary field's value.
func (s *GroupSummary) SetInsightsConfigurationSummary(v *InsightsConfigurationSummary) *GroupSummary {
	s.InsightsConfigurationSummary = v
	return s
}
...
type ImpactStatistics struct {
	...
	RequestRate *float64 `type:"double"`
}

// String returns the string representation
func (s ImpactStatistics) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s ImpactStatistics) GoString() string {
	return s.String()
}

// SetRequestRate sets the RequestRate field's value.
func (s *ImpactStatistics) SetRequestRate(v float64) *ImpactStatistics {
	s.RequestRate = &v
	return s
}
...
// String returns the string representation
func (s ImpactedService) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s ImpactedService) GoString() string {
	return s.String()
}

// SetServiceId sets the ServiceId field's value.
func (s *ImpactedService) SetServiceId(v *ServiceId) *ImpactedService {
	s.ServiceId = v
	return s
}
...
type Insight struct {
	...
	TopAnomalousServices []*ImpactedService `type:"list"`
}
...
func (s *Insight) SetTopAnomalousServices(v []*ImpactedService) *Insight {
...
type InsightEvent struct {
	...
	GroupImpactStatistics *ImpactStatistics `type:"structure"`

	RootCauseServiceImpactStatistics *ImpactStatistics `type:"structure"`

	Title *string `type:"string"`

	TopRootServicesImpacted []*ImpactedService `type:"list"`

	TotalRootServicesImpacted *int64 `type:"integer"`
}
...
// SetGroupImpactStatistics sets the GroupImpactStatistics field's value.
func (s *InsightEvent) SetGroupImpactStatistics(v *ImpactStatistics) *InsightEvent {
	s.GroupImpactStatistics = v
	return s
}

// SetRootCauseServiceImpactStatistics sets the RootCauseServiceImpactStatistics field's value.
func (s *InsightEvent) SetRootCauseServiceImpactStatistics(v *ImpactStatistics) *InsightEvent {
	s.RootCauseServiceImpactStatistics = v
	return s
}

// SetTitle sets the Title field's value.
func (s *InsightEvent) SetTitle(v string) *InsightEvent {
	s.Title = &v
	return s
}

// SetTopRootServicesImpacted sets the TopRootServicesImpacted field's value.
func (s *InsightEvent) SetTopRootServicesImpacted(v []*ImpactedService) *InsightEvent {
	s.TopRootServicesImpacted = v
	return s
}

// SetTotalRootServicesImpacted sets the TotalRootServicesImpacted field's value.
func (s *InsightEvent) SetTotalRootServicesImpacted(v int64) *InsightEvent {
	s.TotalRootServicesImpacted = &v
	return s
}

type InsightIncidentGraphEdge struct {
	_ struct{} `type:"structure"`
...
// String returns the string representation
func (s InsightIncidentGraphEdge) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s InsightIncidentGraphEdge) GoString() string {
	return s.String()
}

// SetReferenceId sets the ReferenceId field's value.
func (s *InsightIncidentGraphEdge) SetReferenceId(v int64) *InsightIncidentGraphEdge {
	s.ReferenceId = &v
	return s
}

type InsightIncidentGraphService struct {
	_ struct{} `type:"structure"`

	AccountId *string `type:"string"`

	Edges []*InsightIncidentGraphEdge `type:"list"`
...
// String returns the string representation
func (s InsightIncidentGraphService) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s InsightIncidentGraphService) GoString() string {
	return s.String()
}

// SetAccountId sets the AccountId field's value.
func (s *InsightIncidentGraphService) SetAccountId(v string) *InsightIncidentGraphService {
	s.AccountId = &v
	return s
}

// SetEdges sets the Edges field's value.
func (s *InsightIncidentGraphService) SetEdges(v []*InsightIncidentGraphEdge) *InsightIncidentGraphService {
	s.Edges = v
	return s
}

// SetName sets the Name field's value.
func (s *InsightIncidentGraphService) SetName(v string) *InsightIncidentGraphService {
	s.Name = &v
	return s
}

// SetNames sets the Names field's value.
func (s *InsightIncidentGraphService) SetNames(v []*string) *InsightIncidentGraphService {
	s.Names = v
	return s
}

// SetReferenceId sets the ReferenceId field's value.
func (s *InsightIncidentGraphService) SetReferenceId(v int64) *InsightIncidentGraphService {
	s.ReferenceId = &v
	return s
}

// SetType sets the Type field's value.
func (s *InsightIncidentGraphService) SetType(v string) *InsightIncidentGraphService {
	s.Type = &v
	return s
}
...
// SetTopAnomalousServices sets the TopAnomalousServices field's value.
func (s *InsightSummary) SetTopAnomalousServices(v []*ImpactedService) *InsightSummary {
	s.TopAnomalousServices = v
	return s
}
...
func (s *InsightsConfiguration) SetEnabled(v bool) *InsightsConfiguration {
	s.Enabled = &v
	return s
}

type InsightsConfigurationSummary struct {
	_ struct{} `type:"structure"`
...
// String returns the string representation
func (s InsightsConfigurationSummary) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s InsightsConfigurationSummary) GoString() string {
	return s.String()
}

// SetEnabled sets the Enabled field's value.
func (s *InsightsConfigurationSummary) SetEnabled(v bool) *InsightsConfigurationSummary {
	s.Enabled = &v
	return s
}
...
type LegacySamplingRule struct {
	_ struct{} `type:"structure"`
...
// String returns the string representation
func (s LegacySamplingRule) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s LegacySamplingRule) GoString() string {
	return s.String()
}

// SetIdentifier sets the Identifier field's value.
func (s *LegacySamplingRule) SetIdentifier(v string) *LegacySamplingRule {
	s.Identifier = &v
	return s
}

// SetPercentage sets the Percentage field's value.
func (s *LegacySamplingRule) SetPercentage(v float64) *LegacySamplingRule {
	s.Percentage = &v
	return s
}

// SetReservoirSize sets the ReservoirSize field's value.
func (s *LegacySamplingRule) SetReservoirSize(v int64) *LegacySamplingRule {
	s.ReservoirSize = &v
	return s
}
...
type PutExtensibleTelemetryInput struct {
	_ struct{} `type:"structure"`

	EC2InstanceId *string `type:"string"`

	// ExtensibleTelemetryList is a required field
	ExtensibleTelemetryList []*ExtensibleTelemetry `type:"list" required:"true"`
...
// String returns the string representation
func (s PutExtensibleTelemetryInput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s PutExtensibleTelemetryInput) GoString() string {
	return s.String()
}

// Validate inspects the fields of the type to determine if they are valid.
func (s *PutExtensibleTelemetryInput) Validate() error {
	invalidParams := request.ErrInvalidParams{Context: "PutExtensibleTelemetryInput"}
	if s.ExtensibleTelemetryList == nil {
		invalidParams.Add(request.NewErrParamRequired("ExtensibleTelemetryList"))
	}
	if s.ExtensibleTelemetryList != nil {
		for i, v := range s.ExtensibleTelemetryList {
			if v == nil {
				continue
			}
			if err := v.Validate(); err != nil {
				invalidParams.AddNested(fmt.Sprintf("%s[%v]", "ExtensibleTelemetryList", i), err.(request.ErrInvalidParams))
			}
		}
	}
...
func (s *PutExtensibleTelemetryInput) SetEC2InstanceId(v string) *PutExtensibleTelemetryInput {
	s.EC2InstanceId = &v
	return s
}

// SetExtensibleTelemetryList sets the ExtensibleTelemetryList field's value.
func (s *PutExtensibleTelemetryInput) SetExtensibleTelemetryList(v []*ExtensibleTelemetry) *PutExtensibleTelemetryInput {
	s.ExtensibleTelemetryList = v
	return s
}

// SetHostname sets the Hostname field's value.
func (s *PutExtensibleTelemetryInput) SetHostname(v string) *PutExtensibleTelemetryInput {
	s.Hostname = &v
	return s
}

// SetResourceARN sets the ResourceARN field's value.
func (s *PutExtensibleTelemetryInput) SetResourceARN(v string) *PutExtensibleTelemetryInput {
	s.ResourceARN = &v
	return s
}

type PutExtensibleTelemetryOutput struct {
	_ struct{} `type:"structure"`
}

// String returns the string representation
func (s PutExtensibleTelemetryOutput) String() string {
	return awsutil.Prettify(s)
}

// GoString returns the string representation
func (s PutExtensibleTelemetryOutput) GoString() string {
	return s.String()
}
...
type Service struct {
	...
	ApproximateContributorStatistics []*ContributorStatistics `type:"list"`
	...
	TopContributors []*ContributorCategory `type:"list"`
...
// SetApproximateContributorStatistics sets the ApproximateContributorStatistics field's value.
func (s *Service) SetApproximateContributorStatistics(v []*ContributorStatistics) *Service {
	s.ApproximateContributorStatistics = v
	return s
}
...
func (s *Service) SetTopContributors(v []*ContributorCategory) *Service {
	s.TopContributors = v
	return s
}
...
type ServiceStatistics struct {
	...
	ForecastStatistics *ForecastStatistics `type:"structure"`
...
// SetForecastStatistics sets the ForecastStatistics field's value.
func (s *ServiceStatistics) SetForecastStatistics(v *ForecastStatistics) *ServiceStatistics {
	s.ForecastStatistics = v
	return s
}
...
type TraceSummary struct {
	...
	DurationRootCauses []*DurationRootCause `type:"list"`
...
// SetDurationRootCauses sets the DurationRootCauses field's value.
func (s *TraceSummary) SetDurationRootCauses(v []*DurationRootCause) *TraceSummary {
	s.DurationRootCauses = v
	return s
}
...
const (
	// InsightCategoryError is a InsightCategory enum value
	InsightCategoryError = "ERROR"

	// InsightCategoryFault is a InsightCategory enum value
	InsightCategoryFault = "FAULT"

	// InsightCategoryThrottle is a InsightCategory enum value
	InsightCategoryThrottle = "THROTTLE"
)

// InsightCategory_Values returns all elements of the InsightCategory enum
func InsightCategory_Values() []string {
	return []string{
		InsightCategoryError,
		InsightCategoryFault,
		InsightCategoryThrottle,
	}
}
...
// TagrisStatus_Values returns all elements of the TagrisStatus enum
func TagrisStatus_Values() []string {
	return []string{
		TagrisStatusActive,
		TagrisStatusNotActive,
	}
}
