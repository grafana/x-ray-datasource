...
const result = new MutableDataFrame({
  fields: [
    ...
    },
    {
      name: 'startTime',
      config: {},
      values: [1591872073.754, 1591872073.754, 1591872073.754, 1591872073.754, 1591872073.754],
    },
    {
      name: 'duration',
      config: {},
      values: [0, 0, 0.04800009727478027, 0.04700016975402832, 0.04700016975402832],
    },
    {
      name: 'logs',
      config: {},
