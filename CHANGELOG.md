...
- feat: add sessionToken handling to support Grafana Assume Role in [#628](https://github.com/grafana/x-ray-datasource/pull/628)
...
- chore: update renovate config to use data-sources base preset in [#619](https://github.com/grafana/x-ray-datasource/pull/619)
...
- chore(deps): update actions/checkout digest to de0fac2 in [#592](https://github.com/grafana/x-ray-datasource/pull/592)
- chore(deps): update dependency @grafana/plugin-e2e to v3.2.1 in [#591](https://github.com/grafana/x-ray-datasource/pull/591)
- chore(deps): update dependency @grafana/aws-sdk to v0.9.0 in [#589](https://github.com/grafana/x-ray-datasource/pull/589)
- chore(deps): update dependency sass to v1.97.3 in [#586](https://github.com/grafana/x-ray-datasource/pull/586)
- chore(deps): update dependency @grafana/plugin-e2e to v3.2.0 in [#588](https://github.com/grafana/x-ray-datasource/pull/588)
- chore(deps): update dependency @testing-library/react to v16.3.2 in [#584](https://github.com/grafana/x-ray-datasource/pull/584)
- chore(deps): update grafana monorepo to v12.3.2 in [#587](https://github.com/grafana/x-ray-datasource/pull/587)
- chore(deps): update dependency go to v1.25.6 in [#553](https://github.com/grafana/x-ray-datasource/pull/553)
- chore(deps): update dependency @types/node to v24.10.9 in [#585](https://github.com/grafana/x-ray-datasource/pull/585)
- chore(deps): update dependency @types/testing-library__jest-dom to v6 in [#568](https://github.com/grafana/x-ray-datasource/pull/568)
- chore(deps): update grafana/plugin-ci-workflows/ci-cd-workflows action to v6.1.0 in [#582](https://github.com/grafana/x-ray-datasource/pull/582)
- chore(deps): update node.js to v24 in [#583](https://github.com/grafana/x-ray-datasource/pull/583)
- chore(deps): update dependency eslint-plugin-jsdoc to v62 in [#572](https://github.com/grafana/x-ray-datasource/pull/572)
- fix(deps): update module golang.org/x/text to v0.33.0 in [#581](https://github.com/grafana/x-ray-datasource/pull/581)
- chore(deps): update dependency prettier to ^3.8.0 in [#580](https://github.com/grafana/x-ray-datasource/pull/580)
- fix(deps): update go patch updates in [#579](https://github.com/grafana/x-ray-datasource/pull/579)
- chore(deps): update dependency react-router-dom to v6.30.3 in [#577](https://github.com/grafana/x-ray-datasource/pull/577)
- chore(deps): update dependency swc-loader to ^0.2.6 in [#578](https://github.com/grafana/x-ray-datasource/pull/578)
- chore(deps): update dependency @playwright/test to ^1.57.0 in [#549](https://github.com/grafana/x-ray-datasource/pull/549)
- chore(deps): update dependency lefthook to ^2.0.13 in [#576](https://github.com/grafana/x-ray-datasource/pull/576)
- chore(deps): update actions/stale action to v10 in [#566](https://github.com/grafana/x-ray-datasource/pull/566)
- chore(deps): update actions/checkout action to v6 in [#565](https://github.com/grafana/x-ray-datasource/pull/565)
- chore(deps): update dependency lefthook to v2 in [#574](https://github.com/grafana/x-ray-datasource/pull/574)
- chore(deps): update dependency glob to v13 in [#573](https://github.com/grafana/x-ray-datasource/pull/573)
- chore(deps): update dependency sass to v1.97.2 in [#554](https://github.com/grafana/x-ray-datasource/pull/554)
- chore(deps): update dependency eslint-plugin-jsdoc to ^61.5.0 in [#571](https://github.com/grafana/x-ray-datasource/pull/571)
- chore(deps): update dependency @typescript-eslint/eslint-plugin to ^8.52.0 in [#550](https://github.com/grafana/x-ray-datasource/pull/550)
- use prod environment for cd workflow in [#544](https://github.com/grafana/x-ray-datasource/pull/544)
- chore(deps): update dependency eslint-plugin-jsdoc to v61 in [#569](https://github.com/grafana/x-ray-datasource/pull/569)
- chore(deps): update dependency @grafana/eslint-config to v9 in [#567](https://github.com/grafana/x-ray-datasource/pull/567)
- fix(deps): update module golang.org/x/text to v0.32.0 in [#564](https://github.com/grafana/x-ray-datasource/pull/564)
- fix(deps): update module golang.org/x/sync to v0.19.0 in [#563](https://github.com/grafana/x-ray-datasource/pull/563)
- fix(deps): update module github.com/aws/aws-sdk-go-v2/service/applicationsignals to v1.18.3 in [#561](https://github.com/grafana/x-ray-datasource/pull/561)
- fix(deps): update dependency @grafana/plugin-ui to ^0.12.0 in [#560](https://github.com/grafana/x-ray-datasource/pull/560)
- chore(deps): update yarn to v4.12.0 in [#559](https://github.com/grafana/x-ray-datasource/pull/559)
- chore(deps): update dependency webpack to ^5.104.1 in [#556](https://github.com/grafana/x-ray-datasource/pull/556)
- chore(deps): update jest monorepo to ^30.2.0 in [#558](https://github.com/grafana/x-ray-datasource/pull/558)
- chore(deps): update grafana monorepo to v12.3.1 in [#557](https://github.com/grafana/x-ray-datasource/pull/557)
- chore(deps): update dependency eslint-plugin-jsdoc to ^50.8.0 in [#552](https://github.com/grafana/x-ray-datasource/pull/552)
- chore(deps): update dependency @types/node to ^22.19.3 in [#540](https://github.com/grafana/x-ray-datasource/pull/540)
- chore(deps): update dependency cspell to ^9.4.0 in [#551](https://github.com/grafana/x-ray-datasource/pull/551)
- chore(deps): update dependency typescript to v5.9.3 in [#555](https://github.com/grafana/x-ray-datasource/pull/555)
- chore(deps): update testing-library monorepo in [#519](https://github.com/grafana/x-ray-datasource/pull/519)
- chore(deps): update dependency @grafana/aws-sdk to v0.8.3 in [#548](https://github.com/grafana/x-ray-datasource/pull/548)
- fix(deps): update module github.com/aws/aws-sdk-go-v2/service/xray to v1.36.16 in [#547](https://github.com/grafana/x-ray-datasource/pull/547)
- chore(deps): update dependency @types/testing-library__jest-dom to v5.14.9 in [#515](https://github.com/grafana/x-ray-datasource/pull/515)
- chore(deps): update dependency sass-loader to v16.0.6 in [#546](https://github.com/grafana/x-ray-datasource/pull/546)
- chore(deps): update dependency react-router-dom to v6.30.2 in [#545](https://github.com/grafana/x-ray-datasource/pull/545)
- chore(deps): update dependency glob to v11.1.0 [security] in [#532](https://github.com/grafana/x-ray-datasource/pull/532)
- chore(deps): update dependency semver to v7.7.3 in [#517](https://github.com/grafana/x-ray-datasource/pull/517)
- Update grafana-aws-sdk to 1.4.2 in [#543](https://github.com/grafana/x-ray-datasource/pull/543)
- chore(deps): update module golang.org/x/crypto to v0.45.0 [security] in [#531](https://github.com/grafana/x-ray-datasource/pull/531)
